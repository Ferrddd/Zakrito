...
def st(**tags: float) -> ProcessState:
    return ProcessState(timestamp=datetime(2026, 6, 1), tags=tags)


def test_stable_no_action():
...
def test_all_scenarios_unsafe_refuses():
...
def test_blend_must_sum_to_100():
